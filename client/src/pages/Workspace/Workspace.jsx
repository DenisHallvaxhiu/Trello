        ...
        <div className="boards">
          <div className="recently">
            <div className="header">
              <img
                alt="clock"
                src="data:image/png;base64,"
              />
              <h3>Recently viewed</h3>
            </div>
            <div className="boardcard">
              {boardTest.map((data, index) => (
                <BoardCard data={data} />
              ))}
            </div>
          </div>
